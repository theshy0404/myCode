...
""" 你的 APPID AK SK """
APP_ID = '25662329'
API_KEY = 'E7FWbl7dQDIpBRY2Rz6mI4K0'
SECRET_KEY = 'xFkPUfqnVfG1h45HH14WXT2RvnIGoGDn'

client = AipNlp(APP_ID, API_KEY, SECRET_KEY)


def get_labels(title, content):
    results = client.keyword(title, content)
    labels = []
...
def get_sim(word1, word2):
    return client.simnet(word1, word2);
...
#
# """ 调用词义相似度 """
# print(client.simnet(word1, word2))
